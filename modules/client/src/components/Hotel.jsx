    ...
    <div className="flex  flex-grow max-w-full h-full">
      <div className=" flex hotel flex-col  p-2">
        ...
        {useremail ? (
            <div>
                  <span>
                  <Link href={`/Pay?id=${hotelData._id}&hotelname=${hotelData.name}&capacity=${hotelData.capacity}&price=${hotelData.price}&startDate=${params.get('startDate')}&endDate=${params.get('endDate')}&hotelId=${params.get('hotelId')}`}>
